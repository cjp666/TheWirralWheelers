...
describe("build the text to be spoken about a ride", function() {
    ...
    it("should return the correct details for a next ride", function() {
        ...
        result.should.be.equal(
            "The next ride is level X on Sunday, February 18, 2018, being led by person and will be leaving from starting heading for food"
        );
    });
    ...
    it("should return the correct details for today's ride", function() {
        ...
        result.should.be.equal(
            "Today's ride is level Y on Monday, February 19, 2018, being led by personB and will be leaving from startingB heading for foodB"
        );
    });
    ...
    it("should return the correct details for tomorrow's ride", function() {
        ...
        result.should.be.equal(
            "Tomorrow's ride is level Z on Tuesday, February 20, 2018, being led by personC and will be leaving from startingC heading for foodC"
        );
    });
    ...
    it("should return the correct details for a previous ride", function() {
        ...
        result.should.be.equal(
            "The last ride was Saturday, February 17, 2018 from startingD and was led by personD with lunch at foodD"
        );
    });
});
